...
Notes:
    ...
    cd ~/code/git_well/docs
    sphinx-apidoc --private -f -o ~/code/git_well/docs/source ~/code/git_well/git_well --separate
    make html
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/git-well/advanced/
        ...
        Click import project: (for github you can select, but gitlab you need to import manually)
            Set the Repository NAME: git_well
            Set the Repository URL: https://github.com/Erotemic/git_well

        For gitlab you also need to setup an integrations. Navigate to:

            https://readthedocs.org/dashboard/git-well/integrations/create/
        ...
        Then go to
            ...
            https://github.com/Erotemic/git_well/hooks
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/git-well/versions/
"""
#
...
modpath = join(dirname(dirname(dirname(__file__))), 'git_well', '__init__.py')
...
# html_logo = '.static/git_well.svg'
# html_favicon = '.static/git_well.ico'
...
latex_documents = [
    (master_doc, 'git_well.tex', 'git_well Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'git_well', 'git_well Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'git_well', 'git_well Documentation',
     author, 'git_well', 'One line description of project.',
     'Miscellaneous'),
]
